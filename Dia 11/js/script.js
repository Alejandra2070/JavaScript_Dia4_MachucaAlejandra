        ...
        capsula.forEach(cap => {
                ...
                <div class="capsulanegativa">
                    ...
                    <div class="botonesnegativo">
                        <div class="terminadonegativo">
                            <img src="../Dia 11/storage/img/pngwing.com (2).png" data-id="1" class="completado">
                        </div>
                        <div class="eliminadonegativo">
                            <img src="../Dia 11/storage/img/pngwing.com (4).png" data-id="2" class="eliminado">
                        </div>
                    </div>
                </div>
                `
            ...
            if (cap.status === "On hold"){
                ...
                <div class="capsula">
                    ...
                    <div class="botones">
                        <div class="terminado">
                            <img src="../Dia 11/storage/img/pngwing.com (2).png" data-id="${cap.id}" class="completado">
                        </div>
                        <div class="eliminado">
                            <img src="../Dia 11/storage/img/pngwing.com (4).png" data-id="${cap.id}" class="eliminado">
                        </div>
                    </div>
                </div>
                `
